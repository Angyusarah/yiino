    ...
    <div className=" flex-wrap justify-center overflow-x-hidden">
      ...
      <div className="text-center">
        <p>
          ...
          facere sapiente similique corrupti?
        </p>
      </div>
      ...
      <div className="flex justify-center items-center">
        <div className="flex flex-row items-center space-x-8 lg:space-x-20">
          <div className="flex flex-col items-center mt-9">
            <div className="rounded-full bg-lightblue p-3">
              <img
                className="w-14 h-14"
                src="src\assets\images\education.png"
              />
            </div>
            <p className="text-2xl font-bold mt-7">Education</p>
          </div>

          <div className="flex flex-col items-center mt-9">
            <div className="rounded-full bg-lightblue p-3">
              <img className="w-14 h-14" src="src\assets\images\health.png" />
            </div>
            <p className="text-2xl font-bold mt-7">Health</p>
          </div>

          <div className="flex flex-col items-center mt-9">
            <div className="rounded-full bg-lightblue p-3">
              <img className="w-14 h-14" src="src\assets\images\agric.png" />
            </div>
            <p className="text-2xl font-bold mt-7">Agriculture</p>
          </div>
        </div>
      </div>
